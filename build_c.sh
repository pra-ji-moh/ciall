...
build test_explore $C smarsh_core.c smarsh_explore.c test_explore.c && run_test test_explore $C
build play_arc $C smarsh_core.c smarsh_explore.c play_arc.c
