...
typedef struct {
  ...
  unsigned idle_breaks;   /* times it caught itself taking no act at all, turn after turn */
  unsigned plans_laid, plan_steps, plans_broke;   /* going by what it worked out, not where it has been */
