...
(cd certifiable-c && $CC $FLAGS smarsh_core.c smarsh_interval.c smarsh_space.c smarsh_frame.c smarsh_guess.c smarsh_ending.c smarsh_rules.c smarsh_explore.c play_arc.c -o ../.build/play_arc.exe -lm)
